...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.eI.Zeai' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_EI_ZeaiService()
    {
        return $this->privates['.service_locator.eI.Zeai'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getSecurity_Command_UserPasswordEncoderService()
    {
        ...
        $this->privates['security.command.user_password_encoder'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\UserPasswordEncoderCommand(($this->privates['security.encoder_factory.generic'] ?? $this->getSecurity_EncoderFactory_GenericService()), [0 => 'app\\src\\Entity\\Peoples']);
    ...
    protected function getSecurity_EncoderFactory_GenericService()
    {
        ...
        return $this->privates['security.encoder_factory.generic'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(['app\\src\\Entity\\Peoples' => ['algorithm' => 'auto', 'migrate_from' => [], 'hash_algorithm' => 'sha512', 'key_length' => 40, 'ignore_case' => false, 'encode_as_base64' => true, 'iterations' => 5000, 'cost' => NULL, 'memory_cost' => NULL, 'time_cost' => NULL, 'threads' => NULL]]);
    }
